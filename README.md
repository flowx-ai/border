...
- **Not a finished set of detectors.** 27 of the 29 in the catalogue run on a fresh
...
29 catalogued. 28 implemented. 27 run on a fresh install with no model download, 1 is
