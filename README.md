...
- **Not a finished set of detectors.** 28 of the 30 in the catalogue run on a fresh
...
30 catalogued. 29 implemented. 28 run on a fresh install with no model download, 1 is
